"""
python train_classifier_LSTM.py action=train config=configs/train_classifier.yaml dataset.shift=D1-D1 models.RGB.model=ActionLSTM num_clips=5 name=LSTM_TEST dataset.RGB.data_path="../ek_data/frames/"
"""
...
def main():
    ...
    logger.info(f"Workig on: {device}")
...
def train(action_classifier, train_loader, val_loader, device, num_classes):
    ...
    for i in range(iteration, training_iterations):
        ...
        #             'avg_loss': action_classifier.loss.avg, 
        #             'top1 - accuracy': action_classifier.accuracy.val[1]})
